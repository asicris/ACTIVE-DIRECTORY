...
![estrutura dominio](images/MAIOESTRUTURADOMINIO.png)

## PREPARACIÓN DO ESCENARIO

1. Crea o ROUTER NAT na máquina **UBUSER01-TEUNOME**:

   - Tarxeta en **modo NAT (dhcp)**
   - Tarxeta en **modo INTERNA (172.2x.0.0/16)**
2. O equipo Windows Cliente será: **WIN-02-TEUNOME**
3. O equipo Linux Cliente será: **UBU-01-TEUNOME**

> *TODAS AS MÁQUINAS DEBEN ESTAR DENTRO DUN GRUPO DE VBOX chamado **DCDEVteunome**.*
---
...
4 - Crear unha máquina virtual **DCDEVteunome** partindo da .OVA anterior, E METELA DENTRO DO GRUPO DE VBOX DC-TEUNOME.

5 - **Promover o pc no que acabas de instalar Windows server (DCDevTeunome) a DC**, configurar a dominio **DEVTEUNOME.INTRANET**. Onde *teunome é máximo 4 caracteres do inicio do teu nome de pila*. (Seguir apuntes **INSTALAR DOMAIN CONTROLER**)

6 - Crea un usuario teunome, **co teu nome de pila** (corto), por exemplo (cris) como usuario normal. Ponlle contrasinal: **abc123.**

7 - Unir PC Windows ao dominio (**WIN-02-TEUNOME**)
...
![alt text](images/unidadesorganizativas.png)
